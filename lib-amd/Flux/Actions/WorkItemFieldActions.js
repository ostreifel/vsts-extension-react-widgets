...
define(["require", "exports", "TFS/WorkItemTracking/RestClient", "../Stores/BaseStore", "../Stores/WorkItemFieldStore", "./ActionsCreator"], function (require, exports, WitClient, BaseStore_1, WorkItemFieldStore_1, ActionsCreator_1) {
    "use strict";
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            ActionsCreator_1.WorkItemFieldActionsCreator.InitializeWorkItemFields.invoke(null);
                            return [3, 5];
                        case 1:
                        ...
                        case 3:
                            ...
                            ActionsCreator_1.WorkItemFieldActionsCreator.InitializeWorkItemFields.invoke(workItemFields);
                            return [3, 5];
                        case 4:
                            e_1 = _a.sent();
                            workItemFieldStore.setLoading(false);
                            workItemFieldStore.setError(e_1.message || e_1);
                            return [3, 5];
                        case 5: return [2];
                    }
                });
