...
define(["require", "exports", "VSS/Flux/Action", "TFS/WorkItemTracking/RestClient"], function (require, exports, Action_1, WitClient) {
    ...
    var ActionsCreator = (function () {
        function ActionsCreator(_actionsHub, _workItemFieldStore, _workItemTemplateStore, _workItemTypeStore, _workItemTemplateItemStore, _workItemColorsStore) {
            this._actionsHub = _actionsHub;
            this._workItemFieldStore = _workItemFieldStore;
            this._workItemTemplateStore = _workItemTemplateStore;
            this._workItemTypeStore = _workItemTypeStore;
            this._workItemTemplateItemStore = _workItemTemplateItemStore;
            this._workItemColorsStore = _workItemColorsStore;
        }
        ...
        ActionsCreator.prototype.initializeWorkItemColors = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this._workItemColorsStore.isLoaded()) return [3, 1];
                        ...
                        case 2:
                            _a.sent();
                            workItemTypes = this._workItemTypeStore.getAll();
                            ...
                            return [4, Promise.all(workItemTypes.map(function (wit) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4, WitClient.getClient().getWorkItemTypeStates(projectId_1, wit.name)];
                                            case 1:
                                                stateColors = _a.sent();
        ...
        ActionsCreator.prototype.ensureTemplateItem = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!this._workItemTemplateItemStore.itemExists(id)) return [3, 5];
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
