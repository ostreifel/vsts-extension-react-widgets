...
define(["require", "exports", "VSS/Utils/String", "VSS/Utils/Array", "TFS/WorkItemTracking/RestClient", "./BaseStore"], function (require, exports, Utils_String, Utils_Array, WitClient, BaseStore_1) {
    "use strict";
    ...
    var WorkItemFieldStore = (function (_super) {
        ...
        WorkItemFieldStore.prototype.getItemByKey = function (refName) {
            return Utils_Array.first(this.items, function (item) { return Utils_String.equals(item.referenceName, refName, true); });
        };
        WorkItemFieldStore.prototype.initializeItems = function () {
